  ...
  const values = [
    {
      ...
      icon: <svg className="w-8 h-8 text-[#ff914d] dark:text-[#ff914d]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
    },
    {
      title: "Intégrité",
    ...
    },
    {
      ...
      icon: <svg className="w-8 h-8 text-[#ff914d] dark:text-[#ff914d]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
    },
    {
      title: "Ponctualité",
      ...
      icon: <svg className="w-8 h-8 text-[#ff914d] dark:text-[#ff914d]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    },
    {
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <div key={index} className="bg-gray-50 dark:bg-gray-700 p-8 rounded-lg shadow-md">
              <div className="w-16 h-16 bg-[#fff1e8] dark:bg-[#5e3520] rounded-full flex items-center justify-center mb-6">
                {value.icon}
              </div>
            ...
            <div className="flex justify-center mt-6 space-x-2">
              {values.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${currentSlide === index ? 'bg-[#ff914d]' : 'bg-gray-300 dark:bg-gray-600'}`}
