...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    bio: 'Fort de son expertise technique, Yasin veille à ce que chaque réalisation respecte les normes les plus strictes en matière de qualité et de sécurité. Son expérience sur le terrain garantit l\'excellence de nos prestations.'
  }
];
            ...
            <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  {member.name === 'Ali TOMBARI' ? 'Ali.tombari@erb-btp.fr' : 'yasin.elmatiar@erb-btp.fr'}
                </p>
              </div>
            </div>
          ))}
