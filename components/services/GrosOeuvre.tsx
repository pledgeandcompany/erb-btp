...
const GrosOeuvre: React.FC = () => {
  return (
    <section id="gros-oeuvre" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Le gros œuvre constitue la structure porteuse de votre bâtiment. Notre équipe maîtrise toutes les techniques 
                de construction des fondations aux murs porteurs, en passant par les planchers. Nous garantissons une 
                solidité et une durabilité optimales pour tous types de projets.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <Building className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
                Nos prestations de gros œuvre comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Fondations et infrastructures",
                  "Murs porteurs et poteaux",
                  "Planchers et dalles béton",
          ...
          <div className="order-1 lg:order-2 relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/gros-oeuvre.svg"
                alt="Gros Œuvre"
                fill
