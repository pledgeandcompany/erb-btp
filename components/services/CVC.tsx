...
const CVC: React.FC = () => {
  return (
    <section id="cvc" className="py-8 bg-white dark:bg-gray-900">
          ...
          <div className="order-2 lg:order-1 space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Nous accompagnons clients privés et publics dans la réalisation, l'entretien et la maintenance d'équipements 
                de chauffage, climatisation et ventilation dans le respect des règles RGE.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                ...
                Nos prestations CVC comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Chauffage solutions modernes et efficaces",
