...
const Electricite: React.FC = () => {
  return (
    <section id="electricite" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Depuis sa création en 2016, notre département génie électrique intervient dans les travaux de courant fort, 
                courant faible, chauffage électrique, éclairage public, fibre optique, et vidéo protection.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <Zap className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
                Nos prestations électriques comprennent :
              </h3>
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/electricite.svg"
                alt="Électricité"
                fill
