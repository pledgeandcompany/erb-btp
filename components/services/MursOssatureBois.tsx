...
import { CheckCircle2, Trees } from 'lucide-react';

const MursOssatureBois: React.FC = () => {
  return (
    <section id="murs-ossature-bois" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Ce mode constructif oublié est revenu en force car il présente de nombreux avantages thermiques et environnementaux.  
                Bonne alternative au béton, nous pouvons y insérer tout type d'isolant. Nos ateliers sont équipés de machines 
                d'assemblage et de découpe à commandes numériques qui facilitent la réalisation des panneaux.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <Trees className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
                Nos prestations de murs à ossature bois comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Avantages thermiques et environnementaux",
                  "Alternative durable au béton traditionnel",
                  "Insertion de tout type d'isolant",
                  "Machines d'assemblage et découpe CNC",
                  "Réalisation optimisée des panneaux"
                ].map((item, index) => (
          ...
          <div className="order-1 lg:order-2 relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/ossatures.svg"
                alt="Murs à Ossature Bois"
                fill
...
export default MursOssatureBois;
