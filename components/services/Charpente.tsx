...
const Charpente: React.FC = () => {
  return (
    <section id="charpente" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Traditionnelle ou lamellé-collé, nos charpentiers possèdent le savoir-faire nécessaire aux réali-
                sations les plus complexes. Nous sommes qualifiés en rénovation de charpente monuments historiques, 
                nous permettant de réaliser tout type d'assemblage en bois massif.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                ...
                Nos prestations de charpente comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Charpente traditionnelle et lamellé-collé",
                  "Savoir-faire pour réalisations complexes",
                  "Qualifiés en rénovation de monuments historiques",
                  "Maîtrise de tous types d'assemblages en bois massif",
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/charpente.svg"
                alt="Charpente"
                fill
