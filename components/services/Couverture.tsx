...
const Couverture: React.FC = () => {
  return (
    <section id="couverture" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Premier métier d'utb, la couverture est un savoir-faire que nous cultivons avec nos équipes. 
                Plus de 300 couvreurs formés pour travailler tout type de matériaux tels que le zinc, le cuivre, 
                l'ardoise, la terre cuite ou d'autres matériaux plus futuristes tels que l'acier laqué, 
                l'inox ou le titane. Nous sommes experts de la rénovation de patrimoine ancien et monuments historiques.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <Shield className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
                Nos prestations de couverture comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Plus de 300 couvreurs formés",
                  "Travail de tous types de matériaux (zinc, cuivre, ardoise, terre cuite)",
                  "Matériaux futuristes (acier laqué, inox, titane)",
                  "Experts en rénovation de patrimoine ancien",
                  "Spécialistes monuments historiques"
                ].map((item, index) => (
          ...
          <div className="order-1 lg:order-2 relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/couverture.svg"
                alt="Couverture"
                fill
