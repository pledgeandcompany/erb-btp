...
const ServiceRenovation: React.FC = () => {
  return (
    <section id="renovation" className="py-8 bg-white dark:bg-gray-900">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                Pour une rénovation partielle ou complète, nous mettons notre savoir-faire à votre service pour 
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <ArrowRight className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  "Réaménagement d'espaces intérieurs",
