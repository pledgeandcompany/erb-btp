...
const SerrurerieMetallerie: React.FC = () => {
  return (
    <section id="serrurerie-metallerie" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Nous intervenons sur des chantiers de ferronnerie d'art, de serrurerie et de métallerie en fabrication 
                et pose à neuf, entretien ou dépannage. nos ateliers de préfabrication nous permettent d'intervenir 
                rapidement avec des délais plus courts sur site.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                <span className="bg-[#fff1e8] dark:bg-[#5e3520] p-1.5 rounded-full mr-2">
                  <Wrench className="h-3.5 w-3.5 text-[#ff914d] dark:text-[#ff914d]" />
                </span>
                Nos prestations de serrurerie et métallerie comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Ferronnerie d'art et créations sur mesure",
                  "Serrurerie et métallerie",
                  "Fabrication, pose, entretien et dépannage",
                  "Ateliers de préfabrication",
                  "Intervention rapide et délais optimisés"
                ].map((item, index) => (
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/metallerie.svg"
                alt="Serrurerie Métallerie"
                fill
...
export default SerrurerieMetallerie;
