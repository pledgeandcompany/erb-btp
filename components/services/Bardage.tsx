...
const Bardage: React.FC = () => {
  return (
    <section id="bardage" className="py-8 bg-white dark:bg-gray-900">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                Le bardage est la solution idéale pour protéger et embellir vos façades tout en améliorant l'isolation 
                thermique de votre bâtiment. Nous proposons différents matériaux et finitions pour s'adapter à tous les styles 
                architecturaux.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-md border border-gray-100 dark:border-gray-600">
              <h3 className="text-base font-semibold mb-3 text-gray-800 dark:text-gray-100 flex items-center">
                ...
                Nos prestations de bardage comprennent :
              </h3>
              <ul className="space-y-2">
                {[
                  "Bardage bois et composite",
                  "Bardage métallique et aluminium",
                  "Isolation thermique intégrée",
                  "Finitions et couleurs variées",
                  "Pose sur neuf et rénovation"
                ].map((item, index) => (
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-md overflow-hidden shadow-lg h-[280px] transition-all duration-300 group-hover:shadow-[#fff1e8] dark:group-hover:shadow-[#5e3520]">
              <Image
                src="/images/services/bardage.svg"
                alt="Bardage"
                fill
