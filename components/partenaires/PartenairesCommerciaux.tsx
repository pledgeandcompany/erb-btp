...
const partenairesCommerciaux: Partenaire[] = [
  {
    id: 1,
    nom: "PLEDGE AND GROW",
    description: "Partenaire stratégique pour le développement commercial et la croissance de nos activités",
    logo: "/pledge-logo.png",
    site: "https://pledgeandgrow.com"
  }
];

const PartenairesCommerciaux: React.FC = () => {
  return (
    <section className="py-8">
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Partenaires Commerciaux</h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Nos partenaires commerciaux avec qui nous collaborons pour développer des projets ambitieux.
        </p>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {partenairesCommerciaux.map((partenaire) => (
          <div 
            key={partenaire.id} 
...
export default PartenairesCommerciaux;
